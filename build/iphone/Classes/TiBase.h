...
// in simulator we redefine to format for Nexus Developer console
...
{\
	NSString * exceptionName = [@"org.nexus." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nexus";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINexusNativeItemNone = -1, 
	UINexusNativeItemSpinner = -2,
	UINexusNativeItemProgressBar = -3,
	
	UINexusNativeItemSlider = -4,
	UINexusNativeItemSwitch = -5,
	UINexusNativeItemMultiButton = -6,
	UINexusNativeItemSegmented = -7,
	
	UINexusNativeItemTextView = -8,
	UINexusNativeItemTextField = -9,
	UINexusNativeItemSearchBar = -10,
	
	UINexusNativeItemPicker = -11,
	UINexusNativeItemDatePicker = -12,
	
	UINexusNativeItemInfoLight = -13,
	UINexusNativeItemInfoDark = -14,
	
	UINexusNativeItemDisclosure = -15,
	
	UINexusNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Nexus instances of
